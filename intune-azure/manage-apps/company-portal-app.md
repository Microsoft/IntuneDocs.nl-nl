---
title: De bedrijfsportal-app configureren | Intune Azure Preview | Microsoft Docs
description: 'Intune Azure Preview: meer informatie over hoe u de specifieke huisstijl van uw bedrijf kunt toepassen op de Intune-bedrijfsportal-app. '
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-configure-the-company-portal-app"></a>De bedrijfsportal-app configureren
...
Een aangepaste bedrijfsportal geeft uw eindgebruikers een vertrouwde en nuttige ervaring. Voor het aanpassen van de bedrijfsportal kiest u vanuit de workload **Apps beheren** de optie **Instellen** > **Aangepaste stijl van de bedrijfsportal** en configureert u vervolgens de vereiste instellingen.
