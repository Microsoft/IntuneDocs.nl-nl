---
title: Windows Store-apps toevoegen aan Intune | Intune Azure Preview | Microsoft Docs
...
# <a name="how-to-add-windows-store-apps-to-intune"></a>Windows Store-apps toevoegen aan Intune
