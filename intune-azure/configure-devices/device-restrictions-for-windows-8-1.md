...
# <a name="windows-81-and-later-device-restriction-settings-in-intune-azure-preview"></a>Apparaatbeperkingsinstellingen voor Windows 8.1-apparaten (en hoger) in Intune Azure Preview
