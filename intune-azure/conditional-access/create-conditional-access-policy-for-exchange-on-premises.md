...
- U moet de [Exchange On-Premises-connector Exchange Active Sync](install-intune-on-premises-exchange-connector.md) gebruiken, die Intune verbindt met Exchange On-Premises.
