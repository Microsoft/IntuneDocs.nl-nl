...
-   **Toename van de grootte voor beveiligde bestanden (.pfile)**: Beveiligde bestanden groter dan één gigabyte (1 GB) worden nu ondersteund. Zie [Support File Formats](supported-file-formats.md) (Ondersteunde bestandsindelingen) voor meer informatie over beveiligde bestanden.
...
-   Het standaardgedrag voor het bestands-API-onderdeel van de SDK is bijgewerkt. Zie [Configuratie van bestands-API](file-api-configuration.md) voor meer informatie.
...
-   **Systeemeigen ondersteuning voor alle bestandstypen**
    ...
    Zie [Configuratie van bestands-API](file-api-configuration.md) voor meer informatie over ondersteunde bestandstypen.
...
-   **Integratie van bestands-API**
    ...
    Microsoft Office-bestanden, Portable Document Format-bestanden (PDF) en andere geselecteerde bestandstypen kunnen worden beveiligd met systeemeigen beveiliging. Zie [Configuratie van bestands-API](file-api-configuration.md) voor een volledige lijst met bestandstypen die kunnen worden beveiligd met systeemeigen beveiliging.
...
1 - Door de gebruiker gewenste LCID.
2 - LCID op basis van landinstellingen.
3 - De eerste beschikbare taal die is opgegeven in de Rights Management Server-sjabloon (RMS).
