...
> [!NOTE]
> Zie [On-premises servers that support Azure RMS](..\get-started\requirements-servers.md) (On-premises servers die ondersteuning bieden voor Azure RMS) voor ondersteunde versies van deze on-premises servers.
