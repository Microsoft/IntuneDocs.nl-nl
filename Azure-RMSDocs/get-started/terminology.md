...
|Term|Definitie|
|--------|--------------|
|AADRM|De naam van de Windows PowerShell-module voor Azure Rights Management, die is afgeleid van de onofficiële afkorting voor [!INCLUDE[aad_rightsmanagement_1](../includes/aad_rightsmanagement_1_md.md)] toen dit nog (Windows) Azure Active Directory Rights Management heette.|
...
|afdelingssjabloon|Een rechtenbeleidssjabloon (een aangepaste sjabloon) die u hebt gemaakt en die is geconfigureerd voor weergave aan geselecteerde gebruikers in plaats van alle gebruikers in uw organisatie.|
|toepassingen met functionaliteit|Toepassingen die systeemeigen ondersteuning bieden voor Rights Management, waaronder Office-toepassingen, zoals Word en Excel. Independent software vendors (ISV's) en ontwikkelaars kunnen ook toepassingen schrijven die systeemeigen ondersteuning bieden voor [!INCLUDE[aad_rightsmanagement_2](../includes/aad_rightsmanagement_2_md.md)].|
