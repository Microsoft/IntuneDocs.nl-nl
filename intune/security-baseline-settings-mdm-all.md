...
description: Controleer de standaard instellingen en de beschik baarheid van de verschillende versies van de Windows MDM beveiligings-basis lijn die u kunt beheren met Microsoft Intune.
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 09/06/2019
...
**Preview: MDM-basislijn voor beveiliging voor oktober 2018**  
> [!NOTE]  
...
- **Veilige toegang tot UNC-paden configureren**  
  ...
  **Standaard**: Configureer Windows zo dat alleen toegang tot de opgegeven UNC-paden is toegestaan na het voldoen aan aanvullende beveiligings vereisten
  ...
  Wanneer u *Windows configureert om alleen toegang tot de opgegeven UNC-paden toe te staan nadat aan aanvullende beveiligings vereisten is voldaan* , kunt u de * Hardended UNC-paden lijst configureren.
  - **Lijst met beveiligde UNC-paden**  
    Selecteer **toevoegen** om extra beveiligings vlaggen en server paden op te geven.  
...
- **standaard** 
  **beveiliging op basis van virtualisatie**: Enable vbs with Secure boot
::: zone-end
::: zone pivot="mdm-preview,mdm-may-2019"
