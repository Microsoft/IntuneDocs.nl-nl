...
### <a name="custom-device-settingsconfigurationcustom-settings-windows-holographicmd"></a>[Aangepaste apparaatinstellingen](../configuration/custom-settings-windows-holographic.md)
...
### <a name="configure-kiosk-modeconfigurationkiosk-settings-holographicmd"></a>[Kioskmodus configureren](../configuration/kiosk-settings-holographic.md)
...
### <a name="device-restrictionsconfigurationdevice-restrictions-windows-holographicmd"></a>[Apparaatbeperkingen](../configuration/device-restrictions-windows-holographic.md)
...
### <a name="configure-vpnconfigurationvpn-settings-configuremd"></a>[VPN configureren](../configuration/vpn-settings-configure.md)
...
### <a name="configure-wi-ficonfigurationwi-fi-settings-configuremd"></a>[Wi-Fi configureren](../configuration/wi-fi-settings-configure.md)
