...
5. [Mogelijk moet u extra DNS-records maken voor Intune-inschrijvingen](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium).
...
U vindt meer informatie over het [vereenvoudigen van Windows-inschrijving zonder Azure AD Premium](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium) door een DNS CNAME te maken waarmee de inschrijving wordt omgeleid naar Intune-servers.
