...
Voordat u het probleem probeert op te lossen, controleert u of u Intune op de juiste manier hebt geconfigureerd om registratie mogelijk te maken. Zie [Android- en Standard Knox-apparaten registreren](android-enroll.md) voor koppelingen naar registratiestappen voor elk platform.
...
> U kunt de limiet voor apparaatregistraties vermijden met behulp van apparaatinschrijvingsmanagers, zoals wordt beschreven in [Apparaten inschrijven met de apparaatinschrijvingsmanager](device-enrollment-manager-enroll.md).
>
