...
De eerste stap is ondertekenen van programmacode voor uw APPX-pakket. Zie [app-pakket ondertekenen met behulp van signtool](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool)

## <a name="upload-your-app"></a>Uw app uploaden

Vervolgens uploadt u het ondertekende APPX-bestand, zoals beschreven in [LOB Windows-app uploaden](lob-apps-windows.md)
