...
Als u de huidige instellingen wilt zien, gaat u naar de [instellingen voor IOS kiosk (alleen onder Super visie)](device-restrictions-ios.md#kiosk-supervised-only).
...
Zie [apps weer geven of verbergen (alleen onder Super visie)](device-restrictions-ios.md#show-or-hide-apps-supervised-only)voor meer informatie over deze instellingen.
...
Zie voor meer informatie over de beheerder van Android-apparaten in intune [registratie van Android Device Administrator](https://docs.microsoft.com/intune/android-enroll-device-administrator).
...
- SCEP-certificaten voor volledig beheerde Android zijn beschikbaar voor certificaat verificatie op apparaten die als de eigenaar van het apparaat worden beheerd. SCEP-certificaten worden al ondersteund op werk profiel apparaten.  Met SCEP-certificaten voor de eigenaar van het apparaat kunt u het volgende doen: <!-- 5227935 -->
    ...
    - SCEP-certificaten koppelen aan e-mail profielen voor authenticatie (via AppConfig)
