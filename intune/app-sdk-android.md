...
3. Schakel standaardinschrijving in door de volgende waarde in het manifest in te voeren:
   ```xml
...
4. U schakelt vereist MAM-beleid in door de volgende waarde in het manifest in te voeren:
   ```xml
