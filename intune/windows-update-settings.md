...
- **Standaard**: toestaan
- **Windows-referentiedocumentatie**: [Update/AllowMUUpdateService](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-allowmuupdateservice)
...
- **Standaard**: toestaan
- **Windows-referentiedocumentatie**: [Update/ExcludeWUDriversInQualityUpdate](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-excludewudriversinqualityupdate)
...
- **Standaard**: 0  
- **Windows-referentiedocumentatie**: [Update/DeferQualityUpdatesPeriodInDays](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-deferqualityupdatesperiodindays)  
...
- **Standaard**: 0  
- **Windows-referentiedocumentatie**: [Update/PauseFeatureUpdatesPeriodInDays](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-deferfeatureupdatesperiodindays)  
...
- **Standaard**: 10  
- **Windows-referentiedocumentatie**: [Update/ConfigureFeatureUpdateUninstallPeriod](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-configurefeatureupdateuninstallperiod)  
...
De instellingen voor de gebruikerservaring bepalen de ervaring van de eindgebruiker wat betreft het opnieuw opstarten van het apparaat en ontvangen herinneringen. Raadpleeg de Windows-referentiedocumentatie voor meer informatie over het gedrag van elke instelling.  
...
- **Windows-referentiedocumentatie**: [Update/AllowAutoUpdate](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-allowautoupdate)  
...
- **Automatisch installeren op het tijdstip voor onderhoud**: Updates worden automatisch gedownload en vervolgens geïnstalleerd tijdens Automatisch onderhoud wanneer het apparaat niet in gebruik is of op accustroom werkt. Wanneer opnieuw opstarten nodig is, wordt gebruikers zeven dagen gevraagd opnieuw op te starten, en vervolgens wordt opnieuw opstarten geforceerd.  
  ...
  - **Start gebruikstijd**: geef een begintijd op voor het onderdrukken van opnieuw opstarten vanwege update-installaties.  
    **Windows-referentiedocumentatie**: [Update/ActiveHoursStart](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-activehoursstart)  
    **Standaard**: 8: 00 uur  
  
  - **Einde gebruikstijd**: geef een eindtijd op voor het onderdrukken van opnieuw opstarten vanwege update-installaties.  
    **Windows-referentiedocumentatie**: [Update/ActiveHoursEnd](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-activehoursend)  
    **Standaard**: 17: 00 uur  
...
- **Standaard**: toestaan  
- **Windows-referentiedocumentatie**: [Update/SetEDURestart](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-setedurestart)  
...
- Vanaf Windows-versie 1709: tijdens de gebruikstijd worden de volgende processen niet uitgevoerd voor updates: scannen, downloaden, installeren en opnieuw opstarten. Na de gebruikstijd worden de updateprocessen wel uitgevoerd en kunnen ze het apparaat uit de slaapstand halen, scannen, downloaden, installeren en opnieuw opstarten, zolang het door de accu- en stroomcontrole komt. Zie [Update/SetEDURestart](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-setedurestart) voor meer informatie.  

### <a name="block-user-from-pausing-windows-updates"></a>Voorkomen dat de gebruiker Windows-updates onderbreekt  

- **Standaard**: toestaan  
- **Windows-referentiedocumentatie**: [Update/SetDisablePauseUXAccess](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-setdisablepauseuxaccess)  

Toestaan of verhinderen dat de gebruiker van een apparaat de installatie van een update onderbreekt. 

### <a name="block-user-from-scanning-for-windows-updates"></a>Blokkeren dat de gebruiker kan zoeken naar Windows-updates  
- **Standaard**: toestaan
- **Windows-referentiedocumentatie**: [Update/SetDisableUXWUAccess](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-setdisableuxwuaccess) 

Hiermee geeft u op of u de gebruiker de mogelijkheid van het scannen van Windows Update wilt toestaan of weigeren. Als u bijvoorbeeld *Weigeren* configureert, hebben gebruikers geen toegang tot de scan-, download- en installeerfuncties van Windows Update.  
...
- **Windows-referentiedocumentatie**: [Update/AutoRestartRequiredNotificationDismissal](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-autorestartrequirednotificationdismissal)
...
- **Standaard**: *deze instelling is niet standaard geconfigureerd en er wordt geen herinnering weergegeven aan gebruikers*.  
- **Windows-referentiedocumentatie**: [Update/ScheduleRestartWarning](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-schedulerestartwarning)  
...
- **Standaard**: *deze instelling is niet standaard geconfigureerd en er wordt geen herinnering weergegeven aan gebruikers*.  
- **Windows-referentiedocumentatie**: [Update/ScheduleImminentRestartWarning](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-scheduleimminentrestartwarning) 
...
### <a name="windows-update-notification-level"></a>Niveau van de Windows Update-melding  
- **Standaard**: gebruik de standaard Windows Update-meldingen 
- **Windows-referentiedocumentatie**: [Update/UpdateNotificationLevel](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-updatenotificationlevel)
...
- **Gebruikers overzetten naar gepland opnieuw opstarten na automatisch opnieuw opstarten (dagen)**  
  - **Standaard**: dit is standaard niet geconfigureerd, maar ondersteunt een waarde van **2** tot **30**.  
  - **Windows-referentiedocumentatie**: [Update/EngagedRestartTransitionSchedule](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-engagedrestarttransitionschedule)  
...
- **Herinnering voor gepland opnieuw opstarten uitstellen (dagen)**  
  - **Standaard**: deze instelling is standaard niet geconfigureerd, maar ondersteunt een waarde van **1** tot **3**.  
  - **Windows-referentiedocumentatie**: [Update/EngagedRestartSnoozeSchedule](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-engagedrestartsnoozeschedule)  
...
- **Deadline instellen voor opnieuw opstarten (dagen)**  
  - **Standaard**: deze instelling is standaard niet geconfigureerd, maar ondersteunt een waarde van **2** tot **30**.  
  - **Windows-referentiedocumentatie**: [Update/EngagedRestartDeadline](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-engagedrestartdeadline)  
