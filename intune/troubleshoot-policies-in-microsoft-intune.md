...
4. Zoek onder **Apparaten** het apparaat waarop het probleem zich voordoet. Controleer de verschillende kolommen:
    ...
    - Selecteer het apparaat voor beleidsspecifieke informatie.
      ...
      **Beleidsstatussen**:
      ...
      - **Fouten**: zoek fouten en mogelijke oplossingen op in [Problemen met toegang tot bedrijfsresources oplossen](troubleshoot-company-resource-access-problems.md).
