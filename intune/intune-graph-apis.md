...
Voor het volgende PowerShell-script wordt de AzureAD PowerShell-module gebruikt voor de verificatie.  Zie [Azure Active Directory PowerShell versie 2](https://docs.microsoft.co/powershell/azure/install-adv2?view=azureadps-2.0) en de [voorbeelden voor Intune PowerShell](https://github.com/microsoftgraph/powershell-intune-samples).
