...
- **Name Resolution Policy tabel (NRPT) regels**: Naamomzettingsbeleid (NRPT) regels definiëren hoe namen bij verbinding met de VPN-verbinding in DNS wordt omgezet. Nadat de VPN-verbinding tot stand is gebracht, kunt u kiezen van welke DNS-servers de VPN-verbinding gebruikmaakt.
