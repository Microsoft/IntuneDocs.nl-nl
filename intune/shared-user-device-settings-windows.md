...
- **Gedeelde PC-modus**: kies **inschakelen** gedeelde PC-modus inschakelen. In deze modus kan slechts één gebruiker tegelijk zich aanmelden bij het apparaat. Andere gebruikers kunnen zich pas aanmelden wanneer de eerste gebruiker zich heeft afgemeld. Door **niet te configureren** (standaard), wordt deze instelling niet beheerd via Intune en wordt er geen beleid gepusht voor het configureren van deze instelling op apparaten.
...
- **Time-out (in seconden) slaapstand**: Voer het aantal niet-actieve seconden (0-100) voordat het apparaat in de slaapstand gaat. Als u geen tijd instelt, wordt de slaapstand na 60 minuten ingeschakeld.
