...
titleSuffix: ''
description: Bekijk een lijst met alle Graph API-entiteiten met de overeenkomende Windows CSP en offset-URI op Windows 10-apparaten en hoger, die zijn gebruikt bij het configureren van apparaten in Microsoft Intune. Bekijk de overeenkomende API en CSP voor gedeeld pc's, eindpuntbeveiliging, geavanceerde beveiliging tegen bedreigingen van Microsoft Defender, identiteitsbeveiliging, Windows 10 Teams, Kiosk en Windows Update voor Bedrijven.
keywords: ''
...
Voor Microsoft Intune worden de [Graph API-entiteiten](https://docs.microsoft.com/graph/api/resources/intune-graph-overview) gebruikt (wordt op een andere Docs-site geopend) om apparaten te configureren (**Intune** > **Apparaatconfiguratie**) waarop Windows 10 of hoger wordt uitgevoerd. Voor de Graph API worden configuratie-serviceproviders (CSP's) gebruikt om configuratie-instellingen op apparaten te lezen, in te stellen, te wijzigen en/of te verwijderen.

Deze lijst is van toepassing op:

- Windows 10 en hoger

In dit artikel staan de Graph-entiteiten en de overeenkomende Windows 10-CSP's en offset-URI's.

Deze informatie is nuttig voor diverse scenario's. Bekijk bijvoorbeeld wat er door Intune wordt gebruikt en bekijk instellingen die moeten worden opgenomen in aangepaste OMA-URI-configuraties, enzovoort. 

## <a name="windows-10-csps"></a>Windows 10-CSP's

Zie de [referentie van de configuratie-serviceprovider](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) voor meer informatie over configuratie-serviceproviders voor Windows 10 (wordt in een andere Docs-site geopend).

## <a name="graph-api-properties-to-csp-mapping"></a>Graph API-eigenschappen voor CSP-toewijzing

In de volgende lijst staat het grootste deel van Graph API-entiteiten die door Microsoft Intune worden gebruikt voor de configuratie van Windows 10-apparaten. Ook ziet u de overeenkomende Windows 10-CSP en offset-URI.

Gebruik de [referentie voor configuratie-serviceproviders](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) voor Windows 10 (wordt in een andere Docs-site geopend) voor alle Windows 10-versies waarop de volgende API's van toepassing zijn.
...
### <a name="editionupgradeconfigurationlicensetype"></a>EditionUpgradeConfiguration.License 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
...
### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (apparaten die op de Windows Holographic for Business-editie zijn gericht) 
...
**CSP**: N.v.t.; alleen Graph API-aanroep **offset-URI**: N.v.t. alleen Graph API-aanroep
...
**CSP**: N.v.t.; alleen Graph API **offset-URI**: N.v.t.; alleen Graph API
...
- [Referentie voor configuratie-serviceprovider](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (wordt op een andere Docs-site geopend)
