...
-   EAS (Exchange ActiveSync) moet worden geactiveerd op het apparaat als de gebruiker e-mail ophaalt via de systeemeigen e-mailclient van het apparaat in plaats van met Outlook.     Dit gebeurt automatisch voor iOS-, Windows Phone- en Android/KNOX-apparaten.
...
## Problemen met Exchange ActiveSync

### Op een compatibel Android-apparaat wordt een quarantainemelding weergegeven
...
### Buiten gebruik gesteld apparaat heeft nog steeds toegang.
...
### Apparaat is compatibel en geregistreerd bij AAD maar nog steeds geblokkeerd
...
## Niet-compatibel apparaat niet geblokkeerd
...
## Voordat u een ondersteuningsticket opent
...
### Logboeken van de Exchange Connector

#### Algemene logboekgegevens
...
#### Zoeken naar synchronisatielogboeken
...
##### Uitzonderingen in de opdracht Get next
