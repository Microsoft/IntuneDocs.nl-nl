...
|-2016345599|0x87D10201|Syncml(513): De ontvanger biedt geen ondersteuning of weigert deze voor de opgegeven versie van het SyncML-synchronistatieprotocol dat wordt gebruikt in het aanvraag-SyncML-bericht.|
...
|-2016345602|0x87D101FE|Syncml(510): Tijdens het verwerken van de aanvraag is een fout opgetreden. De fout is gerelateerd aan een fout in de gegevensopslag van de ontvanger.|
...
|-2016345608|=0x87D101F8|Syncml(504): De ontvanger, fungerend als gateway of proxy, heeft geen tijdige reactie ontvangen van de upstream-ontvanger die is opgegeven door de URI (bijvoorbeeld HTTP, FTP of LDAP) of een andere hulpontvanger (bijvoorbeeld DNS) waartoe toegang nodig is voor de poging om de aanvraag te voltooien.|
...
|-2016345611|0x87D101F5|Syncml(501): De ontvanger ondersteunt de opdracht niet die is vereist voor het voltooien van de aanvraag.|
|-2016345612|0x87D101F4|Syncml(500): Er is een onverwachte status opgetreden bij de ontvanger, waardoor deze de aanvraag niet kan voltooien|
