...
title: Uw Windows Phone 8.1-apparaat inschrijven bij Intune | Microsoft Intune
description:
keywords:
author: Staciebarker
manager: jeffgilb
...
# Uw Windows Phone 8.1-apparaat inschrijven bij Intune
...
Volg de instructies die binnen uw bedrijf of school van toepassing zijn voor het inschrijven van een Windows Phone 8.1-apparaat bij Intune:
...
4.  Tik op **Tik om dit apparaat in te schrijven of te identificeren**..

    ![Het scherm Tik om dit apparaat in te schrijven of te identificeren](./media/WP81-enroll-1-swipe-my-devices.png)

5.  Tik op **Dit apparaat inschrijven**..

    ![Het scherm Dit apparaat inschrijven](./media/WP81-enroll-2-enroll-this-device.png)

6.  Tik op **Account toevoegen**..

    ![Het scherm Werkplekinstellingen](./media/WP81-enroll-3-workplace-add-acct.png)

7.  Voer de gevraagde aanvullende gegevens in en tik op **Aanmelden** om de inschrijving te voltooien. Uw werkplekaccount wordt nu weergegeven op de pagina **Instellingen** &gt; **Werkplek**.
...
3.  Voer de gevraagde aanvullende gegevens in en tik op **Aanmelden** om de inschrijving te voltooien.
