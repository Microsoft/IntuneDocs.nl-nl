...
ms.topic: hub-page
title: Microsoft Intune-documentatie | Microsoft Docs
description: Leren werken met Microsoft Intune (CONTROLE)
...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            <a href="#manage">Beheren</a>
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Aanbevolen artikelen</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Populaire artikelen</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Aanbevolen artikelen</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Nieuwe artikelen</h3>
                            </div>
                        </li>
                        <li>
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune-azure/introduction/what-is-microsoft-intune">Intune in de preview-versie van Azure Portal</a></h3>
                                            <p>Terwijl Microsoft Intune wordt verplaatst naar de Azure-portal, kunt u hier meer informatie vinden over de wijzigingen die beschikbaar zijn in de nieuwe portal. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/plan-design/introduction">Ontwerp, planning en implementatie</a></h3>
                                            <p>Het proces doorlopen van het ontwikkelen van een implementatieplan, het maken van een ontwerp, de onboarding van Intune en het uitvoeren van een productie-rollout.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/deploy-use/how-to-educate-your-end-users-about-microsoft-intune">Eindgebruikers instructies geven over Microsoft Intune</a></h3>
                                            <p>Meer informatie over hoe u uw eindgebruikers de overstap kunt laten maken naar de beveiligde toegang van Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Werken met Intune in Microsoft Graph</a></h3>
                                            <p>De API's van Microsoft Graph gebruiken om de besturingselementen en beleidsregels van Intune te configureren.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">Meer dan 150 licenties? Maak gebruik van uw FastTrack-voordelen</a></h3>
                                            <p>U werkt samen met specialisten van Microsoft aan het openen, herstellen, inschakelen en stimuleren van gebruik van uw services.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/understand-explore/mam-faq">Veelgestelde vragen over MAM en app-beveiliging</a></h3>
                                            <p>Hier vindt u antwoorden op enkele veelgestelde vragen over Intune Mobile App Management en de bescherming van apps met Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/understand-explore/introduction-to-microsoft-intune">alle Intune-documentatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">Inleiding</a>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Ontdek hoe Intune beheermogelijkheden biedt op het gebied van apparaten, apps en gegevens voor mobiele apparaten en Windows-pc's.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Evalueren hoe Mobile Device Management werkt in Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/understand-explore/introduction-to-microsoft-intune">alle inleidende documentatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Implementatie van abonnementen</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Doelen, doelstellingen en uitdagingen bepalen</h3>
                                            <p>Bepaal het bereik van de doelen, doelstellingen en uitdagingen die u moet beheren voor implementatie.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Use-casescenario's bepalen</h3>
                                            <p>Bekijk een aantal voorbeelden van use-casescenario’s om uw eigen use-casescenario’s te bepalen voor uw implementatie. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Een rollout-plan ontwikkelen</h3>
                                            <p>Bepaal de organisatiegroepen waarop uw Intune-implementatie is gericht en het tijdsbestek voor de implementatie voor elke groep.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/plan-design/introduction">alle documentatie voor abonnementsimplementatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Procedures</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Beleid voor voorwaardelijke toegang maken</h3>
                                            <p>Configureer de voorwaardelijke toegang voor Exchange On-Premises op basis van apparaatnaleving.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>MDM-instantie instellen</h3>
                                            <p>Meer informatie over de beschikbare opties bij het instellen van de Mobile Device Management-instantie.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Apparaatprofielen configureren</h3>
                                            <p>Meer informatie over het maken van apparaatconfiguratieprofielen in Microsoft Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Apparaatbeperkingen configureren</h3>
                                            <p>Meer informatie over het configureren van apparaatbeperkingsinstellingen in Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Apps beheren</h3>
                                            <p>Meer informatie over het toevoegen, toewijzen en controleren van apps.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Beveiligingsbeleid voor apps maken en toewijzen</h3>
                                            <p>Meer informatie over het maken en toewijzen van beveiligingsbeleid voor app.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">alle documentatie met meer informatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">Bewaken en problemen oplossen</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Meer informatie over bekende problemen in de preview-versie van Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Problemen met app-implementatie oplossen</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Problemen met apparaatinschrijving oplossen</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Problemen met apparaatprofielen oplossen</h3>
                                            <p>Problemen oplossen die zijn opgetreden bij het maken van profielen voor apparaten.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Problemen met e-mailprofielen oplossen</h3>
                                            <p>Problemen oplossen die zijn opgetreden bij het maken van e-mailprofielen.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">alle documentatie voor probleemoplossing</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Overzicht van de Intune App SDK</h3>
                                            <p>Meer informatie over de SDK waarmee u uw app kunt inschakelen voor Intune-appbeveiliging.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Werken met Intune in Microsoft Graph</h3>
                                            <p>De API's van Microsoft Graph gebruiken om de besturingselementen en beleidsregels van Intune te configureren.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Line-Of-Business-apps voorbereiden voor MAM</h3>
                                            <p>Laat uw apps gebruik maken van Mobile Application Management-beleid (MAM) door de Intune App Wrapping Tool of de Intune App SDK te gebruiken.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zoekt u alle documentatie? Zie <a href="/intune/understand-explore/introduction-to-microsoft-intune">alle Intune-documentatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Feedback geven over Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Volg Microsoft Intune op Twitter</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Vragen stellen en beantwoorden op het forum</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Lees de Enterprise Mobility and Security-blog (Engelstalig)</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Feedback geven over de Intune-service</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Feedback geven over de Intune-documentatie</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
