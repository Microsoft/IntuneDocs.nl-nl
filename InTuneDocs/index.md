...
<article id="main">
    <section id="hero-content">
      ...
      <h2>Mobiele apparaten en apps en pc's beheren vanuit de cloud. </h2>
      <h3>Wilt u Intune beheren met Configuration Manager? <a href="https://docs.microsoft.com/en-us/sccm/mdm/understand/choose-between-standalone-intune-and-hybrid-mobile-device-management" target="_blank">Meer informatie over hybride beheer van mobiele apparaten &rarr;</a></h3>
    </section>
    <section id="featured" class="container">
      ...
      <div class="features row">
        <ul class="column column-half">
          ...
          <li><a href="/intune-azure/introduction/what-is-microsoft-intune">Intune in de preview-versie van Azure Portal</a></li>
        </ul>
        <ul class="column column-half">
