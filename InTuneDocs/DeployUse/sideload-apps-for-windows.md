...
1.  **De bedrijfsportal downloaden**
    ...
    U kunt de Windows Phone 8.1-bedrijfsportal (offline gelicentieerd pakket) ook downloaden uit de [Windows Store voor Bedrijven](http://businessstore.microsoft.com/). De bedrijfsportal-app moet worden opgehaald met een offline-licentie en het juiste pakket moet worden gedownload voor offlinegebruik. In de aanbiedingen voor het Windows 8- en Windows Phone 8-platform in de selectie wordt verwezen naar de versies voor Windows 8.1.
