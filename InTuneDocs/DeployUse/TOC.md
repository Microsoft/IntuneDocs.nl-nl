...
### [Voorbereidingen voor het inschrijven van apparaten in Intune](get-ready-to-enroll-devices-in-microsoft-intune.md)
...
#### [Windows-apparaatbeheer instellen ](set-up-windows-device-management-with-microsoft-intune.md)
...
##### [Directe iOS-inschrijving](ios-direct-enrollment-in-microsoft-intune.md)
##### [iOS-DEP-inschrijving](ios-device-enrollment-program-in-microsoft-intune.md)
#### [Inschrijven met apparaatinschrijvingsmanager](enroll-corporate-owned-devices-with-the-device-enrollment-manager-in-microsoft-intune.md)
...
#### [Android-instellingen](android-policy-settings-in-microsoft-intune.md)
#### [Instellingen voor Windows 8 en Windows 8.1](windows-configuration-policy-settings-in-microsoft-intune.md)
#### [Instellingen voor Windows Phone 8.1](windows-phone-8-1-policy-settings-in-microsoft-intune.md)
#### [Instellingen voor Windows 10 Desktop en Mobile](windows-10-policy-settings-in-microsoft-intune.md)
#### [Instellingen voor Windows Team](windows-team-configuration-policy-settings-in-microsoft-intune.md)
#### [Upgrade-instellingen voor Windows-editie](edition-upgrade-policy-settings-in-microsoft-intune.md)
#### [Instellingen voor Mac OS X](mac-os-x-policy-settings-in-microsoft-intune.md)
...
## [Apparaten beschermen](protect-your-devices-with-microsoft-intune.md)
...
### [Activeringsvergrendeling op iOS overslaan](help-protect-ios-devices-with-activation-lock-bypass-for-microsoft-intune.md)
...
### [Beleidsregels voor de configuratie van iOS-apps](configure-ios-apps-with-mobile-app-configuration-policies-in-microsoft-intune.md)
...
#### [Een nalevingsbeleid voor apparaten implementeren](deploy-and-monitor-a-device-compliance-policy-in-microsoft-intune.md)
