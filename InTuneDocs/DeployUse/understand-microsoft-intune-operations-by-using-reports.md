...
## Using Reports (Rapporten gebruiken)
...
|**Certificate Compliance Reports**|Weergeven welke certificaten via SCEP of PKCS #12 (.pfx) zijn uitgegeven aan gebruikers en apparaten. Met dit rapport kunt u zoeken naar certificaten die zijn uitgegeven, verlopen en ingetrokken.|
|**Device History Reports**|Een historisch logboek van intrekkings-, wis- en verwijderingsacties weergeven. Gebruik dit rapport om te zien wie in het verleden acties op apparaten heeft gestart.|
