...
**Taak 1**: certificaatsjablonen configureren op de certificeringsinstantie**Taak 2**: de Intune-certificaatconnector inschakelen, installeren en configureren
...
1.  Gebruik op de verlenende CA de module Certificaatsjablonen om een nieuwe aangepaste sjabloon te maken of een bestaande sjabloon te kopiëren en vervolgens een bestaande sjabloon te bewerken (zoals de gebruikerssjabloon) voor gebruik met .pfx.
...
3.  Als naar het clientcertificaat voor de certificaatconnector wordt gevraagd, klikt u op **Selecteren**en selecteert u het certificaat voor **clientverificatie** dat u in Taak 3 hebt geïnstalleerd.
