...
Met aangepaste configuraties kunt u VPN-profielen maken in Intune. Ga als volgt te werk om een aangepaste configuratie te maken:
   ...
   ![Dialoogvenster met aangepaste configuratie van een VPN-profiel](intune/media/Intune_Add_VPN_URI.png)

   4.  Nadat u alle URI-instellingen hebt ingevoerd, klikt u op **Beleid opslaan** en vervolgens implementeert u het beleid.

## Configuratiebeleid implementeren
...
Systeemeigen VPN voor Contoso (IKEv2):
...
Voor vragen over hoe deze instellingen moeten worden gebruikt of voor meer informatie over wat ze doen, raadpleegt u de CSP-documentatie:
