...
title: Instellingen en functies op uw apparaten beheren met Microsoft Intune-beleid | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
Zie [De toegang tot e-mail en O365-service beperken met Microsoft Intune](restrict-access-to-email-and-o365-services-with-microsoft-intune.md) voor meer informatie..
...
Zie [Documentatie voor Microsoft Intune-beleid](microsoft-intune-policy-reference.md) voor een volledige lijst met Intune-beleid..
...
2.  Kies het gewenste beleid. Kies de aanbevolen instellingen voor het beleid (indien beschikbaar; u kunt deze instellingen later wijzigen) of kies ervoor een aangepast beleid te maken met uw eigen instellingen.
    ...
    > [!TIP]
    > Zie [Documentatie voor Microsoft Intune-beleid](microsoft-intune-policy-reference.md) voor meer informatie over het kiezen van het juiste beleid..

3.  Klik op **Beleid maken** als u klaar bent..
...
- **Implementatie beheren**: selecteer de groep waarop u het beleid wilt implementeren en klik op **Toevoegen**..
...
3.  Klik in de rechterbenedenhoek van de Intune-beheerconsole op **Externe taken** om de taakstatus te controleren.

## Naslaginformatie voor Intune-beleid
...
- Windows-computers die als apparaten zijn ingeschreven: om de 24 uur
...
### Wat er gebeurt wanneer een beleid wordt verwijderd of niet langer van toepassing is
...
- **Instellingen voor Endpoint Protection**: de instellingen worden teruggezet naar de aanbevolen waarden. De enige uitzondering hierop is de instelling **Deelnemen aan Microsoft Active Protection Service** waarvoor de standaardwaarde **Nee**is. Zie [Help Windows-pc's beveiligen met Endpoint Protection Help voor Microsoft Intune](help-secure-windows-pcs-with-endpoint-protection-for-microsoft-intune.md) voor meer informatie..
...
- **Instellingen voor Windows Firewall**: de instellingen worden opnieuw ingesteld op de standaardwaarde voor het computerbesturingssysteem. Zie [Help Windows-pc's beveiligen met Endpoint Protection Help voor Microsoft Intune](help-secure-windows-pcs-with-endpoint-protection-for-microsoft-intune.md) voor meer informatie..
