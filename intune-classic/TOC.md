...
## [Inleiding tot Intune](understand-explore/introduction-to-microsoft-intune.md)
## [Intune voor onderwijs](understand-explore/introduction-to-intune-education.md)
...
## [Implementatie plannen, ontwerpen en uitvoeren](plan-design/introduction.md)
...
## [Migreren](plan-design/intune-mdm-migration-guide.md)
### [Fase 1: Intune voorbereiden voor MDM](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [Basisinstallatie](plan-design/migration-phase1-basic-setup.md)
#### [Beheerbeleid voor apparaten en apps configureren](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [Beveiligingsbeleid voor apps configureren](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [Speciale overwegingen bij migratie](plan-design/migration-phase1-special-migration-considerations.md)
### [Fase 2: Migratiecampagne](plan-design/migration-phase2-migration-campaign.md)
#### [Communicatieplanning](plan-design/migration-phase2-communication-plan.md)
#### [Ingebruikname stimuleren](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [Normale migratiecyclus](plan-design/migration-phase2-typical-migration-cycle.md)
...
## [Wat is nieuw in de Azure-preview?](/intune/whats-new?toc=/intune-classic/toc.json&bc=/enterprise-mobility/toc.json)
...
### [Levenscyclus van apparaten](deploy-use/overview-of-device-lifecycle-in-microsoft-intune.md)
### [Levenscyclus van apps](deploy-use/overview-of-app-lifecycle-in-microsoft-intune.md)
...
### [Line-Of-Business-apps voorbereiden voor MAM](deploy-use/decide-how-to-prepare-apps-for-mobile-application-management-with-microsoft-intune.md)
#### [iOS-apps verpakken](deploy-use/prepare-ios-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
#### [Android-apps verpakken](deploy-use/prepare-android-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
...
### [Ervaring van eindgebruikers voor Android met MAM-apps](deploy-use/user-experience-for-mam-enabled-android-apps-with-microsoft-intune.md)
### [Ervaring van eindgebruikers voor iOS met MAM-apps](deploy-use/user-experience-for-mam-enabled-ios-apps-with-microsoft-intune.md)
...
## [Aan de slag met de Microsoft Intune App SDK](develop/intune-app-sdk-get-started.md)
## [Ontwikkelaarshandleiding voor Intune App SDK voor iOS](develop/intune-app-sdk-ios.md)
## [Ontwikkelaarshandleiding voor de Intune App SDK voor Android](develop/intune-app-sdk-android.md)
## [Intune App SDK Cordova-invoegtoepassing](develop/intune-app-sdk-cordova.md)
## [Intune App SDK Xamarin-onderdeel](develop/intune-app-sdk-xamarin.md)
