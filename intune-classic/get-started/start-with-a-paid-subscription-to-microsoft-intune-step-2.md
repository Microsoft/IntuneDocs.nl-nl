...
4. Het weergegeven dialoogvenster **Domein controleren** bevat de waarden die u nodig hebt om de TXT-record in uw DNS-hostingprovider te maken.
    ...
    > [!TIP]
    > Maak een DNS-alias /intune-classic/deploy-use/set-up-windows-phone-management-with-microsoft-intune) terwijl u wijzigingen aanbrengt aan de DNS-hostingprovider.
