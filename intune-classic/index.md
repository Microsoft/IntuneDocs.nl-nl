                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Waar is de Intune-functie die ik zoek gebleven in Azure?</h3>
                                            <p>Als u bekend bent met Intune in de klassieke console, kunt u aan de hand van dit artikel de functie vinden in Intune op Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/what-is-intune">alle Intune-documentatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/what-is-intune">alle inleidende documentatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune-classic/plan-design/introduction">alle documentatie voor abonnementsimplementatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune/device-enrollment">alle documentatie met procedures</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zie <a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">alle documentatie voor probleemoplossing</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Zoekt u alle documentatie? Zie <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">alle Intune-documentatie</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
