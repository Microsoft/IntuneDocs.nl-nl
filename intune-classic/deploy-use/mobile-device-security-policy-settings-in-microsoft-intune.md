...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|------------|---------------------------------------|-----------------|-----------------------------------|
|                                                                                                                                                                <strong>Wachtwoord vereisen voor het ontgrendelen van mobiele apparaten</strong>                                                                                                                                                                 |               Nee               |     Nee     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                 <strong>Vereist wachtwoordtype</strong><br /><br />Met deze instelling geeft u het type wachtwoord op dat is vereist, zoals alleen numeriek of alfanumeriek.                                                                                                                 |              Ja               |    Ja     |                  Ja                  |       Ja       |                Nee                 |
| <strong>Vereist wachtwoordtype – minimumaantal tekensets</strong><br /><br />Er zijn vier tekensets: kleine letters, hoofdletters, cijfers en symbolen. Deze instelling geeft aan hoeveel verschillende tekensets moeten worden opgenomen in het wachtwoord. Voor iOS-apparaten geeft u hiermee echter het aantal symbooltekens aan dat moet zijn opgenomen in het wachtwoord. |              Ja               |    Ja     |                  Ja                  |       Ja       |                Nee                 |
|                                                                                                                                                                          <strong>Minimale wachtwoordlengte</strong>                                                                                                                                                                           |              Ja               |    Ja     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                                               <strong>Eenvoudige wachtwoorden toestaan</strong><br /><br />Eenvoudige wachtwoorden zijn onder andere '0000' en '1234'.                                                                                                                                                |               Nee               |     Nee     |                  Ja                  |       Ja       |                Nee                 |
|                                                                                                                                                  <strong>Aantal herhaalde, mislukte aanmeldingen dat is toegestaan voordat het apparaat wordt gewist</strong>                                                                                                                                                   |              Ja               |    Ja     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                                                         <strong>Minuten van inactiviteit voordat het scherm wordt uitgeschakeld</strong><sup>1</sup>                                                                                                                                                          |              Ja               |    Ja     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                                                                         <strong>Dagen tot wachtwoord verloopt</strong>                                                                                                                                                                         |              Ja               |    Ja     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                                                                         <strong>Wachtwoordgeschiedenis onthouden</strong>                                                                                                                                                                          |              Ja               |    Ja     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                                              <strong>Wachtwoordgeschiedenis onthouden</strong> – <strong>Wachtwoorden niet opnieuw gebruiken</strong>                                                                                                                                              |              Ja               |    Ja     |                  Ja                  |       Ja       |                Ja                |
|                                                                                                                                                                              <strong>Wachtwoordkwaliteit</strong>                                                                                                                                                                              |               Nee               |     Nee     |                  Nee                   |       Nee        |                Ja                |
|                                                                                                                                                                       <strong>Afbeeldingswachtwoord en PIN toestaan</strong>                                                                                                                                                                       |              Ja               |    Ja     |                  Nee                   |       Nee        |                Nee                 |
|                                                                                                                                                             <strong>Minuten van inactiviteit voordat wachtwoord vereist is</strong>                                                                                                                                                              |               Nee               |     Nee     |                  Nee                   |       Ja       |                Nee                 |
|                                                                                                                                                                          <strong>Vingerafdruk voor ontgrendelen toestaan</strong>                                                                                                                                                                          |               Nee               |     Nee     |                  Nee                   | iOS 7 en hoger |                Nee                 |
...
|                                                                                                                                     Naam van de instelling                                                                                                                                     | Windows 8.1 en Windows RT 8.1 | Windows RT |              Windows Phone 8 en Windows Phone 8.1              | iOS | Android en Samsung KNOX Standard |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|------------|-----------------------------------------------------------------|-----|-----------------------------------|
| <strong>Versleuteling vereisen op mobiele apparaat</strong><sup>1</sup><br /><br />Voor Windows Phone 8-apparaten moet u dit instellen op <strong>Ja</strong>.<br /><br />Schakel de instelling <strong>Wachtwoord vereist voor het ontgrendelen van mobiele apparaten</strong>in om versleuteling van iOS-apparaten in te schakelen. |              Ja               |     Nee     |                               Ja                               | Nee  |                Ja                |
|                                                                    <strong>Versleuteling vereisen op opslagkaarten</strong><br /><br />Deze instelling is ook van toepassing op apparaten die worden beheerd door Exchange Active Sync.                                                                     |              n.v.t.               |    n.v.t.     | n.v.t. <br />De apps en de bijbehorende gegevens worden automatisch versleuteld. | n.v.t. |                Ja                |
...
|**Schermopname toestaan**|Nee|Nee|Alleen Windows Phone 8.1|Ja|Ja (alleen Samsung KNOX Standard)|
...
|**Verzending van diagnostische gegevens toestaan**|Ja|Nee|Alleen Windows Phone 8.1|Ja|Ja (alleen Samsung KNOX Standard)|
...
|**Microsoft-account optioneel maken in de Windows Mail-toepassing**|Ja|Nee|Nee|Nee|Nee|
...
|Naam van de instelling|Windows 8.1 en Windows RT 8.1|Windows RT|Windows Phone 8 en Windows Phone 8.1|iOS|Android en Samsung KNOX Standard|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**Webbrowser toestaan**|Nee|Nee|Alleen Windows Phone 8.1|Ja|Ja (alleen Samsung KNOX Standard)|
|**Automatisch invullen toestaan**|Ja|Nee|Nee|Ja|Ja (alleen Samsung KNOX Standard)|
|**Pop-upblokkering toestaan**|Ja|Nee|Nee|Ja|Ja (alleen Samsung KNOX Standard)|
|**Cookies toestaan**|Nee|Nee|Nee|Ja|Ja (alleen Samsung KNOX Standard)|
|**Invoegtoepassingen toestaan**|Ja|Nee|Nee|Nee|Nee|
|**Active Scripting toestaan**|Ja|Nee|Nee|Ja|Ja (alleen Samsung KNOX Standard)|
|**Waarschuwingen voor fraude toestaan**|Ja|Nee|Nee|Ja|Nee|
|**Intranetsite voor invoer van één woord toestaan**<br /><br />(Met deze instelling staat u toe dat er één woord wordt gebruikt om Internet Explorer naar een website te sturen, zoals ‘Bing’.)|Ja|Nee|Nee|Nee|Nee|
...
|Naam van de instelling|Windows 8.1 en Windows RT 8.1|Windows RT|Windows Phone 8 en Windows Phone 8.1|iOS|Android en Samsung KNOX Standard|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**Toepassingsarchief toestaan**|Nee|Nee|Alleen Windows Phone 8.1|Ja|Ja (alleen Samsung KNOX Standard)|
...
|Naam van de instelling|Windows 8.1 en Windows RT 8.1|Windows RT|Windows Phone 8 en Windows Phone 8.1|iOS|Android en Samsung KNOX Standard|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**Spraakroaming toestaan**|Nee|Nee|Nee|Ja|Ja (alleen Samsung KNOX Standard)|
|**Dataroaming toestaan**|Ja|Nee|Nee|Ja|Ja (alleen Samsung KNOX Standard)|
